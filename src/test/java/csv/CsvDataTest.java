...
class CsvDataTest {
    ...
    void testmakeNetwork(@TempDir java.nio.file.Path tempDir) {
        ...
        java.nio.file.Path filePath = tempDir.resolve("testmakeNetworkpath.csv");
        try {
        ...
        var csvSchedules = "8;Lourmel;12:30;1\n" +
                ...
                "14;Bercy;17:00;1\n" +
                "14;Bercy;18:00;1";
        java.nio.file.Path fileSchedule = tempDir.resolve("testmakeNetworkschedule.csv");
        try {
        ...
        pathList.add(new Path("8", "1",
                new ArrayList<LocalTime>(List.of(LocalTime.of(12, 30), LocalTime.of(17, 0), LocalTime.of(18, 0))),
        ...
        Network actual;
        try {
            actual = CsvData.makeNetwork(filePath.toString(), fileSchedule.toString());
